...
render_header('Serviços');
?>
<section class="card" style="margin-top:12px">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap">
        <div>
            <h2 style="margin:0">Serviços</h2>
            <p class="muted" style="margin:6px 0 0">Cadastre os serviços e seus valores.</p>
        </div>
        <div class="actions">
            <a class="btn btn--primary" href="services.php?action=create">Novo serviço</a>
        </div>
    </div>
    ...
    <?php elseif ($action === 'delete'): ?>
        <div style="margin-top:16px">
            <p class="muted">Tem certeza que deseja excluir este serviço?</p>
