...
<section class="container">
    <div class="grid grid--2">
        ...
        <div class="card">
            ...
            <p class="muted">
                Sistema de gestão para uma barbearia com login (autenticação no banco) e painel administrativo protegido.
            </p>
            <p class="muted">
                Para testes, use o administrador criado em <code>backend/scripts/seed_admin.php</code>.
            </p>
        </div>
    </div>
</section>
